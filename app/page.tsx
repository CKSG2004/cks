          ...
          <main className="flex-1 space-y-24 max-w-2xl">
            ...
            <section id="contact" className="scroll-mt-24 space-y-6 pb-12">
              ...
              <div className="grid grid-cols-2 gap-4 pt-2">
                <a href="mailto:your.email@example.com" className="text-sm text-neutral-400 hover:text-neutral-100 transition-colors">
                  email ↗
                </a>
                <a href="https://github.com" target="_blank" className="text-sm text-neutral-400 hover:text-neutral-100 transition-colors">
                  github ↗
                </a>
                <a href="https://linkedin.com" target="_blank" className="text-sm text-neutral-400 hover:text-neutral-100 transition-colors">
                  linkedin ↗
                </a>
